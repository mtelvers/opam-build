...
let package_name =
  Arg.(value & pos 0 string "" &
       info ~docv:"PACKAGE-NAME" ~doc:"The name and version of the package in the format pkg.x.y.z." [])
